...
class IatRecorder {
    constructor(config) {
        ...
        this.appId = '5f210f4a'
        this.apiKey = '9e8845c5d79373a8104b91f0f1a70b68'
    }
...
class IatTaste {
    ...
    setResult(data) {
        ...
        rtasrResult.forEach(i => {
            ...
            if (i.cn.st.type == 1) {
                $('#result_output').html(self.outputText + self.currText)
                self.currText = ''
            } else {
                self.outputText = self.outputText + self.currText
                self.currText = ''
                $('#result_output').html(self.outputText)
            }
