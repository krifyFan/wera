...
<script lang="ts">
    ...
    export default class Unity3d_WebGL extends Vue {
        ...
        loadUnity() {
            ...
            let config: any = {
                width: (document.getElementById(this.id) as HTMLElement).offsetWidth,
                height: (document.getElementById(this.id) as HTMLElement).offsetHeight,
                params: {
                    enableDebugging: "0"
                }
            }
            ...
            let _this = this
            this.unityInstance.observeProgress(function (progress: any) {
