<template>
    <div
        class="pieChart_customized-wrap"
        :id="id"
        ref="element"
    ></div>
</template>
...
import { ChartData, Series, BaseData } from "@/types/components/chart.interface";
...
export default class About extends Vue {
    ...
    initData() {
        ...
        // let visualMap: EChartOption.VisualMap = {
        //     show: false,
        //     min: 80,
        //     max: 600,
        //     inRange: {
    ...
    drawChart() {
        ...
        data.sort(
            (
                a: EChartOption.SeriesPie.DataObject,
                b: EChartOption.SeriesPie.DataObject
            ) => {
